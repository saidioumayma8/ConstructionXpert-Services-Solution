...
<head>
    ...
    <title>Add Tache - ConstructionXpert</title>
...
<div class="flex h-screen">
    ...
    <main class="flex-1 p-8">
        ...
        <form action="modifytask" method="post" class="bg-gray-800 p-6 shadow-lg rounded-lg mt-6">
            ...
            <label for="budget">Project</label>
